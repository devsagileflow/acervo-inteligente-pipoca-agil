...
- Verificado em 2026-09-24: tipos de evento do front (`apps/web/src/lib/analytics.ts`) batem com `analyticsEventTypeSchema` do pacote compartilhado — sem tensão de contrato conhecida no momento.
