...
import {
  ...
  CreateTrailItemBody,
  createTrailItemBodySchema,
  ListTrailsQuery,
  listTrailsQuerySchema,
  MarkTrailItemViewedBody,
  markTrailItemViewedBodySchema,
  PaginatedTrails,
  paginatedTrailsSchema,
  Result,
  resultSchema,
  Trail,
  trailItemParamsSchema,
  TrailItem,
  TrailItemParams,
  trailItemSchema,
  trailParamsSchema,
  TrailParams,
  trailProgressDetailsSchema,
  TrailProgressDetails,
  trailProgressParamsSchema,
  TrailProgressParams,
  trailSchema,
  UpdateTrailBody,
  updateTrailBodySchema,
  UpdateTrailItemBody,
  updateTrailItemBodySchema,
